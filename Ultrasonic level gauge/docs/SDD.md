...
- По центру **`XX.YY`**: белый текст + инверсия только в зоне заливки (частичное перекрытие тоже ок).
- OLED 0.96" SSD1306 — монохром (1 бит). «Жёлтый/синий» модуль красит зоны стекла физически, софтом цвет пикселя не выбрать.
